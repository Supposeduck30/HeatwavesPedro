...
@TeleOp
public class TurretThroughPutGobilda extends OpMode {
    ...
    // KICKER AS BLOCKER
    public static final double KICKER_BLOCK = 0.42;  // Blocks balls (default)
    public static final double KICKER_OPEN = 0.49;   // Lets balls through (when triangle held)
