...
public class SumoTeleOpWithTurret extends OpMode {
    ...
    public void loop() {
        ...
        turretController.aimAtGoal(currentPose);
        ...
        double currentAngle = turretController.getCurrentAngle();  // FIXED: was getCurrentPedroAngle()
        ...
        telemetry.addData("Motor Mode", turretController.isBusy() ? "RUN_TO_POSITION" : "IDLE");
