...
public class BlueNineBallFar extends OpMode {
    ...
    private final Pose shootPose1 = new Pose(60.56000000000002,18.24000000000001, Math.toRadians(116));
    private final Pose collectRow1 = new Pose(40.6,34.96000000000001, Math.toRadians(180));
    private final Pose takeRow1 = new Pose(13.599999999999996,35.28, Math.toRadians(180));
    private final Pose shootpose2 = new Pose(60.4,18.07999999999999, Math.toRadians(116));
    private final Pose collectRow2 = new Pose(41.519999999999996,59.68, Math.toRadians(180));
    private final Pose takeRow2 = new Pose(12.12,59.88000000000001, Math.toRadians(180));
    private final Pose shootpose3 = new Pose(60.44,17.919999999999987, Math.toRadians(116));
